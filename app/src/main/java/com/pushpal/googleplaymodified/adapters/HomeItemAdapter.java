...
import com.pushpal.googleplaymodified.models.HomeItemModel;
import com.pushpal.googleplaymodified.models.MainItemAppModel;
import com.pushpal.googleplaymodified.models.PopularItemAppModel;
...
//                        ((NormalViewHolder) holder).tv_card_sub_header.setVisibility(View.GONE);
    ...
    private ArrayList<MainItemAppModel> loadNormalList() {
        ...
        if (context != null) {
            mArrayList.add(new MainItemAppModel("Udacity", "4.3", "FREE", R.drawable.ic_udacity, "INSTALL"));
            mArrayList.add(new MainItemAppModel("Facebook", "4.1", "FREE", R.drawable.logo_facebook, "UPDATE"));
            mArrayList.add(new MainItemAppModel("Slack", "4.4", "FREE", R.drawable.logo_slack, "INSTALL"));
            mArrayList.add(new MainItemAppModel("Gmail", "4.3", "FREE", R.drawable.logo_gmail, "OPEN"));
            mArrayList.add(new MainItemAppModel("LinkedIn", "4.2", "FREE", R.drawable.logo_linkedin, "INSTALL"));
            mArrayList.add(new MainItemAppModel("Whatsapp", "4.4", "FREE", R.drawable.logo_whatsapp, "INSTALL"));
            mArrayList.add(new MainItemAppModel("To do", "4.0", "FREE", R.drawable.logo_to_do, "UPDATE"));
            mArrayList.add(new MainItemAppModel("Code Monk", "4.3", "FREE", R.drawable.logo_code_monk, "INSTALL"));
        }
